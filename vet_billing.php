...
<head>
  ...
  <title>Vet Billing - Diagnopet</title>
...
<body>
  <div class="sidebar">
    ...
    <nav class="nav flex-column">
      ...
      <a class="nav-link active" href="vet_billing.php"><i class="fas fa-credit-card"></i> Billing</a>
  ...
  <div class="main-content">
    ...
    <div class="row">
      <div class="col-md-8">
        <div class="card">
          <div class="card-header">
            <h5><i class="fas fa-credit-card"></i> Vet Billing Options</h5>
          </div>
          <div class="card-body">
            <a href="#" class="billing-btn">
            ...
            <a href="#" class="billing-btn">
              <i class="fas fa-question-circle"></i> Billing Support
            </a>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card">
          <div class="card-header">
            <h5><i class="fas fa-info"></i> Billing Summary</h5>
          </div>
          <div class="card-body">
            <p><strong>Current Plan:</strong> Premium Vet</p>
